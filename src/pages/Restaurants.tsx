...
const Restaurants = () => {
  const restaurants = [
    { id: 1, name: "Le Petit Dakar", country: "Sénégal", rating: 4.8, reviews: 245, address: "Paris 18ème", image: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&auto=format&fit=crop", open: true },
    { id: 2, name: "Chez Mama Afrika", country: "Congo", rating: 4.8, reviews: 203, address: "Paris 19ème", image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&auto=format&fit=crop", open: true },
  ];
    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border/50 bg-card/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-6">
          <h1 className="text-4xl font-bold text-foreground">Restaurants</h1>
          <p className="text-muted-foreground mt-2">200 restaurants africains</p>
        </div>
      </header>
