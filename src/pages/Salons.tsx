...
const Salons = () => {
  const salons = [
    { id: 1, name: "Afro Beauty", country: "Côte d'Ivoire", rating: 4.9, reviews: 189, address: "Paris 11ème", image: "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800&auto=format&fit=crop", open: true },
  ];
    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border/50 bg-card/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-6">
          <h1 className="text-4xl font-bold text-foreground">Salons de coiffure</h1>
          <p className="text-muted-foreground mt-2">80 salons spécialisés</p>
        </div>
      </header>
